...
{	
	...
	$result = mysqli_query($mysqli, "UPDATE writer_tb SET name_writer='$name', age='$umur' WHERE id=$id");
...
<body>
    <div class="container">
        ...
        <form action="edit_pen.php" method="post" name="form" class="mt-3">
