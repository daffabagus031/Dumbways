...
<body>
    <div class="container">
        ...
        <table class="table">
        <a href="add_pen.php" class="btn btn-primary mt-1">Tambah</a>
            <thead>
                <tr>
                    <th scope="col">No</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="edit" href="edit_pen.php?id=<?php echo $data['id']; ?>">Detail</a> |
                        <a class="hapus" href="hapus_pen.php?id=<?php echo $data['id']; ?>">Hapus</a>					
                    </td>
                </tr>
                <?php } ?>
            </tbody>
